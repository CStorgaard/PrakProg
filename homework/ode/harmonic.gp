...
set output "harmonic.svg"                             # Output file
...
set yrange [-1.5:1.5]
set size square
plot "harmonic.txt" using 1:2 with linespoints title "y(x)"
...
set yrange [-1.5:1.5]
set size square
plot "harmonic.txt" using 2:3 with linespoints title "Phase Portrait"
